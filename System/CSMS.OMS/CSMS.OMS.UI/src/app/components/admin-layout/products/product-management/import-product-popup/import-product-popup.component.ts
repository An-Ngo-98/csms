...
@Component({
  selector: 'app-import-product-popup',
  templateUrl: './import-product-popup.component.html'
})
export class ImportProductPopupComponent extends DialogComponent<any, any>  {

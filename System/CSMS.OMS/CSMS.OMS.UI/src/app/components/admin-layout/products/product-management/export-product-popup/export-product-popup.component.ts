...
@Component({
  selector: 'app-export-product-popup',
  templateUrl: './export-product-popup.component.html'
})
export class ExportProductPopupComponent extends DialogComponent<any, any> {
